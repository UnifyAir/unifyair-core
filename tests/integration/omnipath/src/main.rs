...
pub const AMF_IP: &str = "10.0.0.1";           // Access and Mobility Management Function
pub const SMF_IP: &str = "10.0.0.2";           // Session Management Function
pub const UPF_IP: &str = "10.0.0.3";           // User Plane Function
pub const NRF_IP: &str = "10.0.0.4";           // Network Repository Function
pub const AUSF_IP: &str = "10.0.0.5";          // Authentication Server Function
pub const PCF_IP: &str = "10.0.0.6";           // Policy Control Function
pub const NSSF_IP: &str = "10.0.0.7";          // Network Slice Selection Function
pub const UDM_IP: &str = "10.0.0.8";           // Unified Data Management
pub const UDR_IP: &str = "10.0.0.9";           // Unified Data Repository
pub const BSF_IP: &str = "10.0.0.10";          // Binding Support Function
pub const CHF_IP: &str = "10.0.0.11";          // Charging Function
pub const SMSF_IP: &str = "10.0.0.12";         // Short Message Service Function
pub const N3IWF_IP: &str = "10.0.0.13";        // Non-3GPP Interworking Function
pub const SEPP_IP: &str = "10.0.0.14";         // Security Edge Protection Proxy
pub const NWDAF_IP: &str = "10.0.0.15";        // Network Data Analytics Function
pub const GMLC_IP: &str = "10.0.0.16";         // Gateway Mobile Location Centre
pub const SCEF_IP: &str = "10.0.0.17";         // Service Capability Exposure Function
pub const EIR_IP: &str = "10.0.0.18";          // Equipment Identity Register
pub const UDSF_IP: &str = "10.0.0.19";         // Unstructured Data Storage Function
pub const LMF_IP: &str = "10.0.0.20";          // Location Management Function
pub const MBSF_IP: &str = "10.0.0.21";         // Multicast Broadcast Service Function
pub const NAF_IP: &str = "10.0.0.22";          // Network Application Function
pub const NEF_IP: &str = "10.0.0.23";          // Network Exposure Function
pub const SCP_IP: &str = "10.0.0.24";          // Service Communication Proxy
pub const SPP_IP: &str = "10.0.0.25";          // Service Producer Proxy
pub const HSS_IP: &str = "10.0.0.26";          // Home Subscriber Server
pub const CBC_IP: &str = "10.0.0.27";          // Cell Broadcast Centre
pub const IWF_IP: &str = "10.0.0.28";          // Interworking Function
pub const DCCF_IP: &str = "10.0.0.29";         // Data Collection Coordination Function

// GNB Simulator IP addresses
pub const RAN1_IP: &str = "10.0.0.101";        // Ran1
pub const RAN2_IP: &str = "10.0.0.102";        // Ran2
pub const RAN3_IP: &str = "10.0.1.103";        // Ran3
...
async fn start_packet_capture() -> Result<Capture<Active>> {
	...
	while attempts < max_attempts {
		...
		println!("Bridge not found yet, waiting... (attempt {}/{})", attempts + 1, max_attempts);
